...
CREATE TABLE "orderDetail" (
  ...
  "dateAllocated" timestamp DEFAULT NULL,
  "PurchaseOrder_id" integer DEFAULT NULL,
  inventory_id integer DEFAULT NULL
);

CREATE INDEX orderdetail_id_idx ON "orderDetail" (id);
CREATE INDEX orderdetail_inventory_id_idx ON "orderDetail" (inventory_id);
CREATE INDEX orderdetail_product_id_idx ON "orderDetail" (product_id);
CREATE INDEX orderdetail_purchaseOrder_id_idx ON "orderDetail" ("PurchaseOrder_id");
CREATE INDEX "fkOrderDetailOrder1_idx" ON "orderDetail" (order_id);
