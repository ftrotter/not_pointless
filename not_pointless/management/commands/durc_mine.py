...
from .durc_mine_utils.include_pattern_parser import IncludePatternParser
from .durc_mine_utils.relational_model_extractor import RelationalModelExtractor
...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        ...
        db_schema_table_patterns = IncludePatternParser.parse_include_patterns(include_patterns)
        
        # Extract the relational model
        relational_model = RelationalModelExtractor.extract_relational_model(
